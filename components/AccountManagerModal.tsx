  ...
  return (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <motion.div
            className="bg-[var(--app-shell-panel)] dark:bg-[#1a1a1a] backdrop-blur-xl w-full sm:w-[480px] sm:max-w-md sm:rounded-2xl rounded-t-2xl shadow-2xl border border-[var(--app-shell-line)] dark:border-white/5 overflow-hidden flex flex-col max-h-[90vh] relative"
