...
import { Fund, PendingTransaction } from '../types';
...
export const AdjustPositionModal: React.FC<AdjustPositionModalProps> = ({ isOpen, onClose, fund }) => {
            ...
            <div className="bg-white dark:bg-card-dark rounded-xl w-full max-w-md overflow-hidden shadow-2xl flex flex-col max-h-[90vh]">
                ...
                <div className="p-6 space-y-4 overflow-y-auto">
                    ...
                    <div className="flex gap-2">
                        <button
                            onClick={() => setType('buy')}
                            className={`flex-1 py-2.5 rounded-lg text-sm font-bold transition-all ${type === 'buy'
                        ...
                        <button
                            ...
                            className={`flex-1 py-2.5 rounded-lg text-sm font-bold transition-all ${type === 'sell'
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-xs font-bold text-gray-500 mb-1">{t('common.operationDate') || '操作日期'}</label>
                            <input
                                type="date"
                                value={opDate}
                        ...
                        <div>
                            <label className="block text-xs font-bold text-gray-500 mb-1">{t('common.operationTime') || '操作时间'}</label>
                            <select
                                value={opTime}
                    ...
                    <div className="flex gap-3 pt-2">
                        ...
                        <button
                            onClick={handleSave}
                            className={`flex-1 py-3 text-sm font-bold text-white rounded-xl ${type === 'buy'
