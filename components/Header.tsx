      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="w-12 h-8 bg-blue-50 dark:bg-blue-900/30 rounded-lg flex flex-col items-center justify-center text-[9px] text-blue-500 dark:text-blue-400 leading-tight p-0.5 cursor-pointer hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors"
          >
            <span className="font-bold">{t('common.changelog')}</span>
          </button>
          <h1 className="text-lg font-bold text-gray-800 dark:text-gray-100 ml-1 sm:ml-0">
            {title}
          </h1>
        </div>
