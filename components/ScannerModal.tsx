      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            >
              <motion.div
                className="bg-white/92 dark:bg-card-dark/92 backdrop-blur-xl rounded-t-2xl sm:rounded-2xl w-full sm:max-w-lg overflow-hidden shadow-2xl max-h-[92vh] sm:max-h-[90vh] flex flex-col"
