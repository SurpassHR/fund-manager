...
import { recognizeHoldingsFromImage, OcrHoldingItem } from '../services/aiOcr';
...
export const ScannerModal: React.FC<ScannerModalProps> = ({ isOpen, onClose }) => {
    ...
    const canAnalyze = useMemo(() => Boolean(apiKey && file), [apiKey, file]);
    ...
    const handleValidate = async () => {
        const updated = await Promise.all(reviewItems.map(async (item) => {
