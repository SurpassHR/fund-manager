...
export const Ticker: React.FC = () => {
  ...
  return (
    ...
    <div className="fixed bottom-[calc(3.5rem+env(safe-area-inset-bottom,0px))] left-0 right-0 bg-white dark:bg-card-dark border-t border-gray-100 dark:border-border-dark h-10 flex justify-center z-40">
