...
const dictionary = {
  en: {
    common: {
      ...
      aiHoldingAnalysisDefaultQuestion: "Please analyze current holdings: returns, risks, concentration, and suggestions.",
  ...
  zh: {
    common: {
      ...
      aiHoldingAnalysisDefaultQuestion: "请基于当前持仓做一次全面分析（收益、风险、集中度与改进建议）。",
